    ...
    LaunchedEffect(Unit) {
        database.get().addOnSuccessListener { snapshot ->
            val biomeList = snapshot.children.mapNotNull { biomeSnapshot ->
                ...
                val enclosures =
                    biomeSnapshot.child("enclosures").children.mapNotNull { enclosureSnapshot ->
                        val enclosureId = enclosureSnapshot.child("id").getValue(String::class.java)
                        val animals =
                            enclosureSnapshot.child("animals").children.mapNotNull { animalSnapshot ->
                                val animalId =
